...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /**
     * Função principal: busca os dados, ordena por vitórias e desenha a tabela.
     */
    function renderVictoryRanking() {
        const players = StorageUtil.get("players");

        // Ordena os jogadores pela quantidade de vitórias (do maior para o menor).
    ...
    function deletePlayer(playerName) {
        ...
        renderVictoryRanking(); // Redesenha a tabela de vitórias.
    ...
    // Renderiza a tabela de ranking de vitórias assim que a página é carregada.
    renderVictoryRanking();
});
